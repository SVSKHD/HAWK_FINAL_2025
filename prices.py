# apps/bot-runner/src/mt5/prices.py
...
try:
    ...
    mt5 = None  # allows tests to inject a fake client

WeekendPolicy = Literal["skip", "previous_trading_day", "next_trading_day"]

def init_mt5() -> None:
    if mt5 is None:
        raise RuntimeError("MetaTrader5 module not available. Install 'MetaTrader5' on Windows.")
    if mt5.initialize():
        return
